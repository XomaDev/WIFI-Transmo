...
public class WIFIActivity implements WifiP2pManager.ActionListener {
    ...
    public WIFIActivity(Activity activity, ActivityListeners.DiscoveryStartedListener discoveryStartedListener,
                        ...
                        ActivityListeners.DisconnectListener disconnectListener, ActivityListeners.SendDataListener sendDataListener) {
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                if(connectionType) {
                    ...
                    socket = new Socket();
                    try {
                        socket.connect(new InetSocketAddress(hostAddress, WiFiTransfer.connectionPort), 700);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
